...
{
	float3 albedo = tex2D(_MainTex, UV_FUNCTION(i).xy).rgb * UNITY_ACCESS_INSTANCED_PROP(_Color).rgb;
	#if defined(_DETAIL_ALBEDO_MAP)
		float detail = tex2D(_DetailTex, UV_FUNCTION(i).zw) * unity_ColorSpaceDouble;
